...
export const AddOnSuggestionSchema = z.object({
  ...
  removed_bonus_tokens: z.array(z.string()).default([]),
  added_bonus_price_now: z.number().default(0),
  added_bonus_price_now_grosz: z.number().int().default(0),
  removed_bonus_price_now: z.number().default(0),
  removed_bonus_price_now_grosz: z.number().int().default(0),
  net_bonus_price_now: z.number().default(0),
  net_bonus_price_now_grosz: z.number().int().default(0),
