  ...
  return (
    <main className="min-h-screen bg-app text-primary">
      ...
      <TemplateModal
        ...
        nameEn={templateModal.nameEn}
        namePl={templateModal.namePl}
        slug={templateModal.slug}
        descriptionEn={templateModal.descriptionEn}
        descriptionPl={templateModal.descriptionPl}
        isActive={templateModal.isActive}
        error={templateModal.error}
        isSubmitting={templateModal.isSaving}
        onNameEnChange={templateModal.setNameEn}
        onNamePlChange={templateModal.setNamePl}
        onSlugChange={templateModal.setSlug}
        onDescriptionEnChange={templateModal.setDescriptionEn}
        onDescriptionPlChange={templateModal.setDescriptionPl}
