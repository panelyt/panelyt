...
import { AddonSuggestionsSection } from "./addon-suggestions";
...
export function SummarySection({ viewModel, labCards, onApplyAddon }: SummarySectionProps) {
